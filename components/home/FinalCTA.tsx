  ...
  return (
    <section className="relative px-4 sm:px-6 py-20">
      <div className="max-w-4xl mx-auto glass-strong rounded-3xl p-10 sm:p-16 text-center relative overflow-hidden">
        ...
        <a
          href={"/dashboard"}
          className="relative inline-flex items-center gap-2 mt-8 font-medium bg-[var(--color-coral)] text-white rounded-full px-7 py-3.5 hover:brightness-110 transition-all"
        >
